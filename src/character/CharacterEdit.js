        ...
        return (
            <div>
                ...
                <FormGroup>
                    ...
                    <Input id="character_race" type="text" name="character_race" value={this.state.character_race} placeholder="enter character race" onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="character_class">Character Class</Label>
                    <Input id="character_class" type="text" name="character_class" value={this.state.character_class} placeholder="enter character class" onChange={this.handleChange} />
                </FormGroup>
